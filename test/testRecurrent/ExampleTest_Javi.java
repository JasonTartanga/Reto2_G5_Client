...
/**
 * Testing class for User's manager view and controller. Tests login view
 * behavior using TestFX framework.
 *
 * @author javi
 */
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class ExampleTest_Javi extends ApplicationTest {
    ...
    /**
     * Test button Create is enabled when login, name, profile and department
     * are all filled.
     */
    @Test
    //@Ignore
    ...
    /**
     * Test button Modify is enabled when login, name, profile and department
     * are all filled and a table row is selected.
     */
    @Test
    //@Ignore
